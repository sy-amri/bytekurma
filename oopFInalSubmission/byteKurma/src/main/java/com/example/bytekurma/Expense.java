...
public class Expense {
    ...
    public Expense(int userId, float amount, String type){
        this.userId = userId;
        this.amount = amount;
        this.category = type;
    }
    ...
    //Methods
    public void insertIntoExpenses(String category, float amount) {
        try {
            // Establish database connection
            Connection connection = DriverManager.getConnection(JDBC_URL, USERNAME, PASSWORD);

            // Retrieve current expense amount
            String queryCurrent = "SELECT " + category + " FROM expenses WHERE user_id = ?";
            ...
            String queryUpdate = "UPDATE expenses SET " + category + " = ? WHERE user_id = ?";
